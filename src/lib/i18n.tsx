...
const en = {
  ...
  'intro.body': 'Use your location for nearby distances, or search a Swiss address or French city.',
  ...
  'search.placeholder': 'Swiss address or French city',
...
const dictionaries: Record<AppLocale, Dictionary> = {
  ...
  de: {
    ...
    'intro.body': 'Nutze deinen Standort oder suche eine Schweizer Adresse oder französische Stadt.',
    ...
    'search.placeholder': 'Schweizer Adresse oder französische Stadt',
  ...
  fr: {
    ...
    'intro.body': 'Utilisez votre position ou recherchez une adresse suisse ou une ville française.',
    ...
    'search.placeholder': 'Adresse suisse ou ville française',
  ...
  it: {
    ...
    'intro.body': 'Usa la posizione oppure cerca un indirizzo svizzero o una città francese.',
    ...
    'search.placeholder': 'Indirizzo svizzero o città francese',
