...
const en = {
  ...
  'providers.showOnlyLabel': '{name}, {count}. Show only.',
  'providers.showOnly': 'Show only {name}',
...
const dictionaries: Record<AppLocale, Dictionary> = {
  ...
  de: {
    ...
    'providers.showOnlyLabel': '{name}, {count}. Nur diesen anzeigen.',
    'providers.showOnly': 'Nur {name} anzeigen',
  ...
  fr: {
    ...
    'providers.showOnlyLabel': '{name}, {count}. Afficher uniquement.',
    'providers.showOnly': 'Afficher uniquement {name}',
  ...
  it: {
    ...
    'providers.showOnlyLabel': '{name}, {count}. Mostra solo questo.',
    'providers.showOnly': 'Mostra solo {name}',
