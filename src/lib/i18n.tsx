...
const en = {
  ...
  'controls.compass': 'Reset map to north',
  'controls.compassHint': 'Compass. Rotate the map with two fingers. Use Left and Right arrows here to rotate, or press Enter to face north.',
  ...
  'errors.headingDenied': 'Motion access is off. Your location is still shown.',
  ...
  'search.placeholder': 'City or address',
...
const dictionaries: Record<AppLocale, Dictionary> = {
  ...
  de: {
    ...
    'controls.compass': 'Karte nach Norden ausrichten',
    'controls.compassHint': 'Kompass. Drehe die Karte mit zwei Fingern. Nutze hier die Pfeiltasten links und rechts zum Drehen oder die Eingabetaste für Norden.',
    ...
    'errors.headingDenied': 'Der Bewegungszugriff ist deaktiviert. Dein Standort wird weiterhin angezeigt.',
    ...
    'search.placeholder': 'Stadt oder Adresse',
  ...
  fr: {
    ...
    'controls.compass': 'Orienter la carte vers le nord',
    'controls.compassHint': 'Boussole. Tournez la carte avec deux doigts. Utilisez ici les flèches gauche et droite pour tourner, ou Entrée pour revenir au nord.',
    ...
    'errors.headingDenied': 'L’accès aux mouvements est désactivé. Votre position reste affichée.',
    ...
    'search.placeholder': 'Ville ou adresse',
  ...
  it: {
    ...
    'controls.compass': 'Orienta la mappa a nord',
    'controls.compassHint': 'Bussola. Ruota la mappa con due dita. Usa qui le frecce sinistra e destra per ruotare, o Invio per tornare a nord.',
    ...
    'errors.headingDenied': 'L’accesso al movimento è disattivato. La tua posizione resta visibile.',
    ...
    'search.placeholder': 'Città o indirizzo',
