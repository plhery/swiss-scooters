...
const en = {
  ...
  'intro.body': 'Use your location for nearby distances, or search a supported city or Swiss address.',
...
const dictionaries: Record<AppLocale, Dictionary> = {
  ...
  de: {
    ...
    'intro.body': 'Nutze deinen Standort oder suche eine unterstützte Stadt oder Schweizer Adresse.',
  ...
  fr: {
    ...
    'intro.body': 'Utilisez votre position ou recherchez une ville couverte ou une adresse suisse.',
  ...
  it: {
    ...
    'intro.body': 'Usa la posizione oppure cerca una città supportata o un indirizzo svizzero.',
