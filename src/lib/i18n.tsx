...
const en = {
  ...
  'sheet.nearby': 'Nearby scooters',
  'sheet.zoomForDetails': 'Zoom in to see individual scooters and their details.',
  'sheet.empty': 'No scooters in this area',
  'sheet.emptyFiltered': 'No scooters match your filters',
  'sheet.emptyHelp': 'Move the map, zoom out, or search another place.',
...
const dictionaries: Record<AppLocale, Dictionary> = {
  ...
  de: {
    ...
    'sheet.nearby': 'Scooter in der Nähe',
    'sheet.zoomForDetails': 'Vergrössere die Karte, um einzelne Scooter und Details zu sehen.',
    'sheet.empty': 'Keine Scooter in diesem Gebiet',
    'sheet.emptyFiltered': 'Keine Scooter entsprechen den Filtern',
    'sheet.emptyHelp': 'Verschiebe die Karte, verkleinere sie oder suche einen anderen Ort.',
  ...
  fr: {
    ...
    'sheet.nearby': 'Trottinettes à proximité',
    'sheet.zoomForDetails': 'Zoomez pour voir chaque trottinette et ses détails.',
    'sheet.empty': 'Aucune trottinette dans cette zone',
    'sheet.emptyFiltered': 'Aucune trottinette ne correspond aux filtres',
    'sheet.emptyHelp': 'Déplacez ou dézoomez la carte, ou cherchez un autre lieu.',
  ...
  it: {
    ...
    'sheet.nearby': 'Monopattini nelle vicinanze',
    'sheet.zoomForDetails': 'Ingrandisci per vedere i singoli monopattini e i dettagli.',
    'sheet.empty': 'Nessun monopattino in questa zona',
    'sheet.emptyFiltered': 'Nessun monopattino corrisponde ai filtri',
    'sheet.emptyHelp': 'Sposta o riduci la mappa oppure cerca un altro luogo.',
